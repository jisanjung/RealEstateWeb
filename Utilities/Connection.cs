...
namespace Utilities
{
    public class DBConnect
    {
        ...
        //String SqlConnectString = "server=cis-mssql1.temple.edu;Database=sp23_3342_tun22982;User id=tun22982;Password=wuu7ahgh3K";

        // Home Connection String - used for working from home using SSH Tunneling. (AT HOME)
        String SqlConnectString = "server=127.0.0.1,5555;Database=sp23_3342_tun22982;User id=tun22982;Password=wuu7ahgh3K";
